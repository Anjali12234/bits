<header class="vs-header header-layout3">
    <div class="header-box-wrap container position-relative d-none d-xl-block">
        <div class="header-box">
            ...
            <a href="tel:+25821462156" class="header-box__number" style="font-size:20px;">+(977)
            ...
            <div class="row align-items-center justify-content-between text-center text-lg-start">
                    ...
                    <div class="header-links style-white">
                        <ul>
                            <li class="d-none d-xxl-inline-block"><i
                                    class="fal fa-map-marker-alt"></i>{{ systemSetting()?->address }}</li>
                ...
                <div class="col-auto d-none d-md-block">
                    <div class="header-social style-white">
                        ...
                        <a href="{{ systemSetting()?->facebook_url }}" target="_blank"><i
                                class="fab fa-facebook-f"></i></a>
                        <a href="{{ systemSetting()?->twitter_url }}" target="_blank"><i class="fab fa-twitter"></i></a>
                        <a href="{{ systemSetting()?->instagram_url }}" target="_blank"><i
                        ...
                        <nav class="main-menu menu-style3 d-none d-lg-block">
                            <ul>
                                ...
                                {{-- @if (auth('student')->check())
                                    <li>
                                        <a href="{{ route('student.certificatePage') }}">Certificate</a>
                                    </li>
                                    <li class="menu-item-has-children">
                                        <a href="#"
                                            style="color: red">{{ auth()->guard('student')->user()->name }}</a>
                                        <ul class="sub-menu">
                                            <li><a href="{{ route('student.dashboard') }}">Dashboard</a></li>
                                            <li><a href="{{ route('student.studentDetail.create') }}">Profile</a></li>
                                ...
                                @else
                                    <li>
                                        <a href="{{ route('studentLogin') }}">Certificate</a>
                                    </li>
                                @endif --}}
                            </ul>
                        </nav>
